...
import com.kenji1947.reselectorlibrary.choice_mode.ChoiceModeAdapter;
...
public class SingleSelectionActivity extends AppCompatActivity {
    private String TAG = SingleSelectionActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new SingleSelectionAdapter(list, this);
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.menu_toast:
                    Toast.makeText(SingleSelectionActivity.this,
